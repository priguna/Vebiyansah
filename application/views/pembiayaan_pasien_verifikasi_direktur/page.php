...
<head>
  ...
  <title>VERIFIKASI DIREKTUR</title>
      ...
      <div class="auth-box" style="max-width: 80%">
        <div id="loginform">
          <div class="logo">
            ...
            <h4 class="font-medium m-b-20" style="text-transform: uppercase;">VERIFIKASI DIrektur</h4>
          </div>
          <!-- Form -->
                ...
                <table width="100%" class="table table-sm table-striped table-bordered">                  
                  ...
                  <tr>
                    <td colspan="2">
                      ...
                      <?php if($data->user_verifikasi_direktur == ''){ 
                        $array = explode(';', $data->jenis_pembiayaan); ?> 
                        <fieldset class="checkbox">
                          <label>
                            <input type="checkbox" name="jenis_pembiayaan[]" value="Pembayaran tunggakan BPJS" <?php $verif = ''; if(in_array('Pembayaran tunggakan BPJS', $array)){ echo 'checked'; $verif = '(Verifikator 2)'; } ?>> 1. Pembayaran tunggakan BPJS <?php echo $verif ?>
                          </label>
                        </fieldset>   
                        <fieldset class="checkbox">
                          <label>
                            <input type="checkbox" name="jenis_pembiayaan[]" value="Pembebasan biaya 100%" <?php $verif = ''; if(in_array('Pembebasan biaya 100%', $array)){ echo 'checked'; $verif = '(Verifikator 2)'; } ?>> 2. Pembebasan biaya 100% <?php echo $verif ?>
                          </label>
                        </fieldset>  
                        <fieldset class="checkbox">
                          <label>
                            <input type="checkbox" name="jenis_pembiayaan[]" value="Pembebasan biaya 50%" <?php $verif = ''; if(in_array('Pembebasan biaya 50%', $array)){ echo 'checked'; $verif = '(Verifikator 2)'; } ?>> 3. Pembebasan biaya 50% <?php echo $verif ?>
                          </label>
                        </fieldset>  
                        <fieldset class="checkbox">
                          <label>
                            <input type="checkbox" name="jenis_pembiayaan[]" value="Pembebasan biaya lainnya" <?php $verif = ''; if(in_array('Pembebasan biaya lainnya', $array)){ echo 'checked'; $verif = '(Verifikator 2)'; } ?>> 4. Pembebasan biaya lainnya <?php echo $verif ?>
                          </label>
                        </fieldset>  
                        <fieldset class="checkbox">
                          <label>
                            <input type="checkbox" name="jenis_pembiayaan[]" value="Pembayaran dari pihak lain" <?php $verif = ''; if(in_array('Pembayaran dari pihak lain', $array)){ echo 'checked'; $verif = '(Verifikator 2)'; } ?>> 5. Pembayaran dari pihak lain <?php echo $verif ?>
                          </label>
                        </fieldset>
                      <?php } else echo str_replace(';', '<br>', $data->jenis_pembiayaan) ?>
                    </td>
                  </tr>                  
                </table>
                ...
                <?php if($data->user_verifikasi_direktur == ''){ ?>
                  ...
                  <div class="form-group text-center">
                    <div class="col-xs-12 p-b-20">                  
                      <input type="hidden" name="update" value="verifikasi_tahap_direktur">

      ...
      <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-4"> 
          ...
          if($this->session->userdata('level_value_'._PREFIX_) == "Administator"){
            ...
            $verifikasi_keuangan = base_url('link/lihat/'.str_replace("=","",base64_encode(json_encode($parameter))));
            ...
            $verifikasi_kasir = base_url('link/verif/'.str_replace("=","",base64_encode(json_encode($parameter))));
            ...
            <table width="100%" class="table table-sm table-striped table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  <td>Verifikasi Keuangan</td>
                  <td><a href="<?php echo $verifikasi_keuangan ?>" target="_blank"><i class="fas fa-link"></i> Link</a></td>
                </tr>
                <tr>
                  <td>Verifikasi Kasir</td>
                  <td><a href="<?php echo $verifikasi_kasir ?>" target="_blank"><i class="fas fa-link"></i> Link</a></td>
                </tr>
              </tbody>
            </table>
          </div>

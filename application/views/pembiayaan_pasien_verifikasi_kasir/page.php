...
<body>
      ...
      <div class="auth-box" style="max-width: 80%">
        <div id="loginform">
          <div class="logo">
            ...
            <h4 class="font-medium m-b-20" style="text-transform: uppercase;">VERIFIKASI Kasir</h4>
          </div>
          <!-- Form -->
              ...
              <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                <table width="100%" class="table table-sm table-striped table-bordered">                  
                  ...
                  <tr>
                    <td colspan="2">
                      ...
                      <input type="text" class="form-control form-control-md" name="pembiayaan_kasir" value="<?php echo $data->pembiayaan_kasir ?>" required>
                    </td>
                  </tr>    
                  <tr>
                    <td colspan="2">
                      <div class="form-group">
                        ...
                        <input type="file" class="form-control form-control-md" name="url_nota" id="url_nota">
                        <input type="hidden" name="url_nota_old" value="<?php echo $data->url_nota ?>">
                      </div>
                    </td>
                  </tr>   
                  <?php if($data->url_nota != ''){ ?>
                    <tr>
                      <td>Lihat Nota</td>
                ...
                <div class="form-group text-center">
                  <div class="col-xs-12 p-b-20">                  
                    <input type="hidden" name="update" value="verifikasi_tahap_kasir">
  ...
  <script type="text/javascript">
    ...
    document.querySelector('input[name="pembiayaan_kasir"]').addEventListener('input', function(e) {

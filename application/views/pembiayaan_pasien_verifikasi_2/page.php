...
<head>
  ...
  <title>VERIFIKASI TAHAP II</title>
      ...
      <div class="auth-box" style="max-width: 80%">
        <div id="loginform">
          <div class="logo">
            ...
            <h4 class="font-medium m-b-20" style="text-transform: uppercase;">VERIFIKASI TAHAP II</h4>
          </div>
          <!-- Form -->
              ...
              <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                <table width="100%" class="table table-sm table-striped table-bordered">                  
                  ...
                  <tr>
                    <td colspan="2">
                      ...
                      <?php if($data->user_verifikasi_2 == ''){ ?>
                        <fieldset class="checkbox">
                          <label>
                            <input type="checkbox" name="jenis_pembiayaan[]" value="Pembayaran tunggakan BPJS" <?php if($data->jenis_pembiayaan == 'Pembayaran tunggakan BPJS') echo 'checked' ?>> 1. Pembayaran tunggakan BPJS
                          </label>
                        </fieldset>   
                        <fieldset class="checkbox">
                          <label>
                            <input type="checkbox" name="jenis_pembiayaan[]" value="Pembebasan biaya 100%" <?php if($data->jenis_pembiayaan == 'Pembebasan biaya 100%') echo 'checked' ?>> 2. Pembebasan biaya 100%
                          </label>
                        </fieldset>  
                        <fieldset class="checkbox">
                          <label>
                            <input type="checkbox" name="jenis_pembiayaan[]" value="Pembebasan biaya 50%" <?php if($data->jenis_pembiayaan == 'Pembebasan biaya 50%') echo 'checked' ?>> 3. Pembebasan biaya 50%
                          </label>
                        </fieldset>  
                        <fieldset class="checkbox">
                          <label>
                            <input type="checkbox" name="jenis_pembiayaan[]" value="Pembebasan biaya lainnya" <?php if($data->jenis_pembiayaan == 'Pembebasan biaya lainnya') echo 'checked' ?>> 4. Pembebasan biaya lainnya
                          </label>
                        </fieldset>  
                        <fieldset class="checkbox">
                          <label>
                            <input type="checkbox" name="jenis_pembiayaan[]" value="Pembayaran dari pihak lain" <?php if($data->jenis_pembiayaan == 'Pembayaran dari pihak lain') echo 'checked' ?>> 5. Pembayaran dari pihak lain
                          </label>
                        </fieldset> 
                ...
                <?php if($data->user_verifikasi_2 == ''){ ?>
                  ...
                  <div class="form-group text-center">
                    <div class="col-xs-12 p-b-20">                  
                      <input type="hidden" name="update" value="verifikasi_tahap_2">
                ...
                <?php } else { ?>
                  <center>
                    ...
                    <p><?php echo $data->user_verifikasi_2_value ?></p>
                    <h5>Pada Tanggal:</h5>
                    <p><?php $split = explode(' ', $data->tgl_verifikasi_2); echo tgl_convert($split[0]).'<br>'.$split[1] ?></p>
                  </center>
                <?php } ?>
              </div>
            </div>

        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-4">
          <div class="form-group">
            <div class="input-group input-group-sm">
              ...
              <select class="form-control form-control-sm" name="level_id" onchange="load_tabel()">
                <option value="all">Semua</option>
                <?php foreach ($select_level as $key){ if($key->id >= $this->session->userdata('level_id_'.APP_NAME)){ ?>
